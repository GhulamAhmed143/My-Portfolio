  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand — just the name */}
        <a href="#home" className="text-white text-lg sm:text-xl font-bold tracking-wide hover:text-emerald-400 transition-colors">
        ...
        <div className="hidden md:flex items-center">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-4 lg:px-5 py-2 lg:py-2.5 rounded-lg text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-500 transition-all hover:-translate-y-0.5"
          >
            <span>Hire Me</span>
